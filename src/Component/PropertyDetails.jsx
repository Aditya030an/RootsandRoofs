...
const PropertyDetails = () => {
  ...
  return (
    <div className="flex mt-20 max-w-[1400px] mx-auto gap-6 items-start mb-3 px-3">
              ...
              <div className="flex md:flex-col gap-3 overflow-x-auto">
                {property?.images?.slice(0, 5).map((img, i) => (
                  <img
                    ...
                    className={`w-28 h-20 object-cover rounded cursor-pointer border-2 border-solid ${mainImage == img ? "border-neutral-500" : " border"}`}
                  />
                ))}
              </div>
  ...
  "
      ...
      "
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12 py-12 px-6 md:px-10 scroll-mt-28">
          {/* ================= ABOUT DEVELOPER ================= */}
