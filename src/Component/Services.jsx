...
const features = [
  ...
  },
  {
    ...
    description:
      "“With a strong foundation in real estate, we continue to guide major property deals and deliver lasting value.”",
...
const ExpertiseSection = () => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-xl font-[tinos] text-gray-700 mt-4 max-w-2xl mx-auto leading-relaxed">
            Complete Property Care & Rental Management with{" "}
            <span className="font-semibold text-[#0e2338]">
              Trust & Transparency
            </span>
            .
          </p>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto z-10">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className="relative z-10 p-6 border-2 border-[#0e2338]/20 rounded-2xl 
      ...
      <section className="bg-white text-slate-900 py-16 px-6 md:px-20 ">
      ...
      <section
        ref={formRef}
        id="lets-talk"
        className="relative mt-2 max-w-6xl mx-auto px-4 md:px-10 pb-10 "
      >
        {/* Background Blobs */}
        {/* <motion.div
